...
VALUES 
    ($1, $2, $3, $4, $5, $6, DEFAULT, $7, $8, $9, $10, NOW())
RETURNING id
`
...
type GetCampaignByIDRow struct {
	...
	UserSurname         sql.NullString
}

func (q *Queries) GetCampaignByID(ctx context.Context, campaignID uuid.UUID) (GetCampaignByIDRow, error) {
...
SET
    ...
    accepted_token_symbol = COALESCE($9, accepted_token_symbol),
